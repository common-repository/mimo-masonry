<p>
		<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:','mimo-masonry' ); ?></label> 
		<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
	</p>
	<p>
		<label for="<?php echo $this->get_field_id( 'ntax' ); ?>"><?php _e( 'Categories to show, use slugs separated by commas:(Only works when Post Type to use = post)','mimo-masonry' ); ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'exclude' ); ?>"><?php _e( 'Categories to hide, use ids separated by commas:(Only works when Post Type to use = post)','mimo-masonry' ); ?></label> 
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'terms' ); ?>"><?php _e( 'Filter taxonomy','mimo-masonry' ); ?></label> 
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'offset' ); ?>"><?php _e( 'Offset, number:','mimo-masonry' ); ?></label> 
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'showposts' ); ?>"><?php _e( 'Number of posts to show:','mimo-masonry' ); ?></label> 
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'imagesize' ); ?> "><?php _e('Image Size to use:', 'mimo-masonry'); ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'posttype' ); ?> "><?php _e('Post Type to use:', 'mimo-masonry'); ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'order' ); ?> "><?php _e('Order:', 'mimo-masonry'); ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'orderby' ); ?> "><?php _e('Order by:', 'mimo-masonry'); ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'columns' ); ?> "><?php _e('Columns to use:', 'mimo-masonry'); ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'filter' ); ?>"><?php _e( 'Filter, number:','mimo-masonry' ); ?></label> 
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'title_number' ); ?>"><?php _e( 'Title Words, number:','mimo-masonry' ); ?></label> 
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'excerpt_number' ); ?>"><?php _e( 'Excerpt Words, number:','mimo-masonry' ); ?></label> 
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'infinite' ); ?> "><?php _e('Infinite Scroll:', 'mimo-masonry'); ?></label>
	...
	<p>
		<label ><?php _e( 'Widget Design Options','mimo-masonry' ); ?></label> 
	</p>
	<p>
		<label for="<?php echo $this->get_field_id( 'hide_filter' ); ?> "><?php _e('Hide Categories Filter:', 'mimo-masonry'); ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'hide_title' ); ?> "><?php _e('Hide Title:', 'mimo-masonry'); ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'hide_image' ); ?> "><?php _e('Hide Image:', 'mimo-masonry'); ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'hide_excerpt' ); ?> "><?php _e('Hide Excerpt:', 'mimo-masonry'); ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'hide_meta' ); ?> "><?php _e('Hide Meta:', 'mimo-masonry'); ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'hide_pagination' ); ?> "><?php _e('Hide Pagination:', 'mimo-masonry'); ?></label>
